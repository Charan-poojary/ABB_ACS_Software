...
public partial class DriverDetail
{
    ...
    public string Dlno { get; set; } = null!;

    public string? Dlvalidity { get; set; }

    public string? Endorsement { get; set; }

    public string? Cert3DayPcvoNo { get; set; }

    public string? Cert3DayPcvoDate { get; set; }

    public string? Cert3DayPcvoValidity { get; set; }

    public string? Cert1DayPcvoNo { get; set; }

    public string? Cert1DayPcvoDate { get; set; }

    public string? Cert1DayPcvoValidity { get; set; }
