        ...
        return (
            <>
                <div className="container employeeContainer  mt-2 justify-content-center align-items-start">
                    <div className='card'>
                        <h1 className="mb-4 ms-2">Employee Blacklist Report</h1>
                            ...
                            <div className="row mb-4">
                                ...
                                <div className="col-md-3 mb-2">
                                    ...
                                    <select
                                        ...
                                        disabled
                                    >
                                        <option value="">Employee Blacklist Report</option>
                                    </select>
                                </div>
                                <div className="col-md-3 mb-2">
                                    <label>From:</label>
...
export default EmployeeBlacklistReport;
