...
const CurrentEmployeesInsidePlant = () => {
        ...
        return (
            <>
                <div className="container employeeContainer  mt-2 justify-content-center align-items-start">
                    <div className='card'>
                        <h1 className="mb-4 ms-2">Current Employees Inside Plant</h1>
                            ...
                            <div className="row mb-4">
                                ...
                                <div className="col-md-3 mb-2">
                                    ...
                                    <select
                                        ...
                                        disabled
                                    >
                                        <option value="">Current Employees Inside Plant</option>
                                    </select>
                                </div>
                                <div className="col-md-3 mb-2">
                                    <label>From:</label>
...
export default CurrentEmployeesInsidePlant;
